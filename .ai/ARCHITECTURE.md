...
- `CharacterAnimator` (клиентский движок процедурной анимации):
  ...
  - Набор из 9 сигнатурных поз мемов поколения Альфа:
    ...
    * `playRizzlerFlourish`: манерный флуриш рукой у виска с изящным наклоном и полуразворотом корпуса на 18°.
    ...
    * `playDashPose`: динамический рывок с наклоном торса вперед на 30°, приподнятой головой и вариантами позы (аэродинамический спринт с отведенными назад руками либо выставленный вперед таран плечом `isShoulderCharge`).
